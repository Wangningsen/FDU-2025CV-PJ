...
# dataset root: contains train/ and test_new/
DATA_DIR="/data1/nwang60/datasets/CV-Dataset"
TEST_SUBDIR="test_new"   # change to "test" if you ever switch back
...
eval_run() {
  ...
  #   (no --use_tta here by default)

  local CKPT="./weights/${NAME}/best_model.pth"

  echo "=============================="
  echo "Exporting test predictions: $NAME"
